...
class Instruction:
    ...
    def accessed_flags(self) -> [CpuFlag]:
        """ Return a list of tuple composed by (CpuFlag, CpuFlagAction) """
        return [(CpuFlag(i), CpuFlagAction(f.action)) for i, f in enumerate(list(i._instruction.accessedFlags))]
